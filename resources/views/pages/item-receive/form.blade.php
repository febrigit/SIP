@extends('layout')
@section('item-receive')
    active
@endsection
@section('content')
    @php
        $metaTitle = 'Item Receive';
        $metaModule = 'item-receive';
        $mode = $data->id ? 'Edit' : 'Add';
        $btnLbl = $data->id ? 'Save Changes' : 'Save';

        $metaModuleDetail = 'item-receive-detail';
    @endphp
    <div class="content">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-sm-12 collapse" id="addItemCollapse">
                                    ...
                                    @csrf
                                    <input type="hidden" name="item_receive_id" value="{{ $data->id }}">
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <table class="table compact table-sm hover table-striped">
                                        ...
                                        @foreach($data->itemReceiveDetail as $item)
                                            <tr>
