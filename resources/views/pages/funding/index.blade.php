    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row mb-3 padding-xs">
                <div class="col-md-6 col-sm-6 col-xs-6"><h5 class="m-0">Donatur</h5></div>
                <div class="col-md-6 col-sm-6 col-xs-6"><a href="{{route('funding.create')}}" class="btn btn-primary float-right btn-md"><i class="fa fa-plus"></i>Tambah</a></div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="{{ url('dashboard/funding/'.$item->id) }}">Detail</a>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item" href="{{ url('dashboard/funding/'.$item->id.'/edit') }}">Edit</a>
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form method="POST" action="{{url('dashboard/funding/'.$item->id)}}">
                                                                @csrf
                                                                @method('DELETE')
